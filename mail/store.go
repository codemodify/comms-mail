// Package mail is the comms-mail client: a pluggable Store plus the
// three-pane desktop UI. The default backend is an empty LocalStore
// (IMAP or POP3 + SMTP + disk cache). The seeded MemoryStore is
// UITK_MAIL=memory only.
//
// It is shared by ./cmd/comms-maild, ./cmd/comms-mail and
// ./cmd/comms-mail-demo, and imports nothing github.com/codemodify/uitoolkit
// does not export.
package mail
